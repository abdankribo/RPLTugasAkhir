    ...
    <div class="container-fluid bg-transparent rounded-4 mt-3">
        <div class="row height  justify-content-around">
            ...
            <div class="col-9 border rounded-4">
                    <h3>Gaji</h3>
                    <div class="search mt-5 mb-3 row justify-content-center ">
                        <form class="d-flex col-5" role="search" action="{{ route('gaji.action') }}" method="gaji">
                            @csrf
                            <input class="form-control me-2 " type="date" placeholder="Search" aria-label="Search" name="tgl_awal">
                            <input class="form-control me-2  " type="date" placeholder="Search" aria-label="Search" name="tgl_akhir">
